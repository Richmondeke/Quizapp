        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'CreateQuizSet',
              path: 'createQuizSet',
              builder: (context, params) => CreateQuizSetWidget(),
            ),
            FFRoute(
              name: 'ScorePage',
              path: 'scorePage',
              builder: (context, params) => ScorePageWidget(
                scoreAquired: params.getParam('scoreAquired', ParamType.int),
                totalQuestions:
                    params.getParam('totalQuestions', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'QuizPage',
            ...
            FFRoute(
              name: 'Chooseusername',
              path: 'chooseusername',
              builder: (context, params) => ChooseusernameWidget(),
            )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: Colors.white,
                  child: Image.asset(
                    'assets/images/Frame_97_opaque.png',
